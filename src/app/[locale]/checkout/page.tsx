        ...
        <div className="flex flex-col gap-3">
          {loading === 'stripe' ? (
            ...
            <button
              ...
              style={{ background: '#635BFF' }}
            >
              <svg viewBox="0 0 52 16" className="w-10 h-3" fill="white">
                <path d="M47.9 0H44.1l-2.7 15.8h3.8l2.7-15.8zm-13 5.2c-1.5-.8-3.1-1.2-4.3-1.2-1.8 0-3.1.6-3.1 1.8 0 .8.6 1.3 1.7 1.8l1.1.4c2.6 1 4.3 2.3 4.3 4.6 0 3.3-2.7 5.6-7 5.6-2.2 0-4.2-.5-6-1.3l.9-3.8c1.5.8 3.2 1.4 5 1.4 2 0 3.2-.7 3.2-1.9 0-.9-.7-1.4-1.9-2l-.9-.4c-2.7-1.2-4.3-2.7-4.3-5.1 0-3.1 2.5-5.4 6.5-5.4 2.1 0 4 .4 5.6 1.1l-.7 3.2zm-19.1-5.2L10.7 10.2 9.5 3.5C9.3 2.3 8.3 1.3 7.1 1l-6.3-1 .1.3c2.7.7 5.1 2.1 5.8 3.9L9.4 15.8h4.4l7.5-15.8h-5.5zm41.2 0H43.2L40.5 15.8h3.8l2.7-15.8z"/>
              </svg>
              Pagar con Stripe
            </button>
          )}
          ...
          >
            {loading === 'paypal' ? (
              ...
              <>
                <svg viewBox="0 0 48 12" className="w-11 h-3" fill="white">
                  <path d="M34.3 0H21.5l-3.3 16.8h4.2l.9-4.6h4.4c4.4 0 7.2-2.1 8.1-6.3.5-2.2.2-4.1-1.1-5.4-.8-.6-2.1-.5-2.1-.5zm-3.7 6.4c-.4 2.2-2.1 3-4.2 3h-2.7l1-5.3h2.8c1.9 0 3.2.8 3.1 2.3zm7.5-6.4l-3.3 16.8h4l3.3-16.8h-4zm12.9 7.7c-1.2-.7-2.5-1.3-2.5-2.1 0-1 .9-1.7 2.4-1.7 1.2 0 2.2.3 3.1.8l.8-3.2c-1-.5-2.2-.8-3.6-.8-3.5 0-6 2.1-6 5.3 0 2.5 1.9 3.7 3.7 4.7 1.3.7 2.5 1.3 2.5 2.2 0 1-.8 1.8-2.3 1.8-1.4 0-2.7-.5-3.6-1.2l-.8 3.3c1.1.6 2.6 1 4.2 1 3.8 0 6.2-2.2 6.2-5.5 0-2.5-1.8-3.7-3.5-4.7zM6.2 0L0 16.8h4.2l.8-2.2h5.1l.8 2.2H15L8.9 0H6.2zm-.6 10.5l2.1-5.8 1.2 5.8H5.6z"/>
                </svg>
                Pagar con PayPal
              </>
            )}
