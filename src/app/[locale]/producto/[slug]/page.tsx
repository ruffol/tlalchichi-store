...
export default async function ProductoDetailPage({ params }: Props) {
  ...
  const altTexts = (Array.isArray(model.imagenes) ? [nombre, ...model.imagenes.slice(1).map(() => `${nombre} — colores`) ] : [nombre])
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 mt-8">
        <ProductGallery
          images={Array.isArray(model.imagenes) ? model.imagenes.slice(1) : []}
